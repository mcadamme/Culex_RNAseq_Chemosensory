...
mv Aligned.out.sam /media/megan/EE9C16C89C168AEB/Noreuil/trimmed_pairs/DGE_GenAligned_SamFiles/M2-1_S5.sam
...
mv Aligned.out.sam /media/megan/EE9C16C89C168AEB/Noreuil/trimmed_pairs/DGE_GenAligned_SamFiles/M2-2_S6.sam
cat Log.final.out >> Log_summary
...
mv Aligned.out.sam /media/megan/EE9C16C89C168AEB/Noreuil/trimmed_pairs/M2-3_S7.sam
cat Log.final.out >> Log_summary
...
mv Aligned.out.sam /media/megan/EE9C16C89C168AEB/Noreuil/trimmed_pairs/M2-4_S8.sam
cat Log.final.out >> Log_summary
...
mv Aligned.out.sam /media/megan/EE9C16C89C168AEB/Noreuil/trimmed_pairs/DGE_GenAligned_SamFiles/M1-1_S1.sam
cat Log.final.out >> Log_summary
...
mv Aligned.out.sam /media/megan/EE9C16C89C168AEB/Noreuil/trimmed_pairs/DGE_GenAligned_SamFiles/M1-2_S2.sam
cat Log.final.out >> Log_summary
...
mv Aligned.out.sam /media/megan/EE9C16C89C168AEB/Noreuil/trimmed_pairs/DGE_GenAligned_SamFiles/M1-3_S3.sam
cat Log.final.out >> Log_summary
...
mv Aligned.out.sam /media/megan/EE9C16C89C168AEB/Noreuil/trimmed_pairs/DGE_GenAligned_SamFiles/M1-4_S4.sam
cat Log.final.out >> Log_summary
...
mv Aligned.out.sam /media/megan/EE9C16C89C168AEB/Noreuil/trimmed_pairs/DGE_GenAligned_SamFiles/M4-1_S13.sam
cat Log.final.out >> Log_summary
...
mv Aligned.out.sam /media/megan/EE9C16C89C168AEB/Noreuil/trimmed_pairs/DGE_GenAligned_SamFiles/M4-2_S14.sam
cat Log.final.out >> Log_summary
...
mv Aligned.out.sam /media/megan/EE9C16C89C168AEB/Noreuil/trimmed_pairs/DGE_GenAligned_SamFiles/M4-3_S15.sam
cat Log.final.out >> Log_summary
...
mv Aligned.out.sam /media/megan/EE9C16C89C168AEB/Noreuil/trimmed_pairs/DGE_GenAligned_SamFiles/M4-4_S16.sam
cat Log.final.out >> Log_summary

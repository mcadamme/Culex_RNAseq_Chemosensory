...
htseq-count -f bam -a 20 -r pos -s reverse --idattr=gene_id  M2-2_S6.bam  /media/fritzlab/EE9C16C89C168AEB/Noreuil/trimmed_pairs/mosquito_genome_assemblies/Culex-quinquefasciatus-Johannesburg_BASEFEATURES_CpipJ2.4.gtf > ./highQual_gene/M2-2_S6_htseq

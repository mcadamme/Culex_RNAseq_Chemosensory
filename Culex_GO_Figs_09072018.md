...
top_14_BP <- list(Parous_only_BP[c(1:14),3],DGC_BP_grVpa[c(1:14),3], DGC_BP_paVma[c(1:14),3], DGC_BP_paVpip[c(1:14),3], DGC_BP_grVpip[c(1:14),3])

tot_data_BP <- list(Parous_only_BP[c(1:nrow(Parous_only_BP)),3],DGC_BP_grVpa[c(1:nrow(DGC_BP_grVpa)),3], DGC_BP_paVma[c(1:nrow(DGC_BP_paVma)),3], DGC_BP_paVpip[c(1:nrow(DGC_BP_paVpip)),3], DGC_BP_grVpip[c(1:nrow(DGC_BP_grVpip)),3])
...
data2_BP <- as.data.frame(top_14_BP, col.names = c("Parous_only","DGC_BP_grVpa", "DGC_BP_paVma", "DGC_BP_paVpip", "DGC_BP_grVpip"))
...
![](Culex_GO_Figs_09072018_files/figure-markdown_github/BP%20GO%20Figs-5.png)
